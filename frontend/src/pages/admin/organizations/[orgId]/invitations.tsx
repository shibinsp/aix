...
import {
  Send, ArrowLeft, Loader2, Search, UserPlus, X, Trash2,
...
export default function OrganizationInvitations() {
  ...
  return (
    <AdminLayout title="Invitations" subtitle={orgData?.name}>
      {/* Header Actions */}
      ...
      <div className="bg-cyber-dark rounded-xl border border-cyber-accent/20 p-4 mb-6">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <select
            ...
            className="px-4 py-2 bg-cyber-darker border border-cyber-accent/20 rounded-lg text-white focus:outline-none focus:border-cyber-accent/50"
          >
          ...
          {isPending && (
            <>
              <button
                ...
                className="p-2 hover:bg-cyber-darker rounded-lg transition-colors text-gray-400 hover:text-cyber-accent"
              ...
              <button
                ...
                className="p-2 hover:bg-cyber-darker rounded-lg transition-colors text-gray-400 hover:text-cyber-accent disabled:opacity-50"
...
function InviteModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-cyber-dark rounded-2xl border border-cyber-accent/30 p-6 max-w-lg w-full mx-4 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 bg-cyber-darker border border-cyber-accent/20 rounded-lg text-white focus:outline-none focus:border-cyber-accent/50 resize-none font-mono text-sm"
              rows={5}
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              ...
              className="flex-1 px-4 py-2 bg-cyber-accent text-cyber-dark rounded-lg hover:bg-cyber-accent/90 transition-colors font-medium disabled:opacity-50 flex items-center justify-center gap-2"
            >
